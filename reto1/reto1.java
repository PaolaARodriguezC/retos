...
public class reto1 {
    ...
    public static void printArray(String[] arr) {
        for (int i = 0; i < arr.length /* Aqui va la longitud del arreglo */ ; i++) {
            System.out.println(arr[i]); // Aqui se imprime el dato que se encuentra en la posiciÃ³n i del arreglo
        }
    }
    ...
    public static int computeComposition(String code) {
        int score = 0; // Puntaje
        if (code.equals("C3")) {
            score +=1 ; // AquÃ­ se suma 1 punto, correspondientes al valor de C3
    ...
    public static String[] computeResults(int score, float nodule_size){
        ...
        if ((score >= 0) && (score <= 1)) {
            ...
            if (nodule_size >= 1) { // El tamaÃ±o del nodulo es mayor o igual a 1
                arr[1] = "aaf";
            } else {
                arr[1] = "seguimiento";
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        scanner.close();
        String[] alertArray = new String[numOfPatients]; // AquÃ­ el tamaÃ±o del arreglo debe ser el mismo que el nÃºmero de pacientes
